...
Story: Logging in
  As an anonymous admin with an account
  ...
  # Log in: get form
  #
  Scenario: Anonymous admin can get a login form.
  ...
  #
  Scenario: Anonymous admin can log in
    Given an anonymous admin
  ...
  Scenario: Logged-in admin who logs in should be the new one
    Given an activated admin named 'reggie'
     And  an activated admin logged in as 'oona'
    When  she creates a singular sessions with login: 'reggie', password: 'monkey', remember me: ''
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see a notice message 'Logged in successfully'
  ...
  #
  Scenario: Anonymous admin can log in and be remembered
    Given an anonymous admin
     And  an activated admin named 'reggie'
    ...
    Then  she should see a notice message 'Logged in successfully'
     ...
     And  her session store should have admin_id: 4
   
  #
  # Log in unsuccessfully
  #
  
  Scenario: Logged-in admin who fails logs in should be logged out
    Given an activated admin named 'oona'
    ...
    Then  she should see an error message 'Couldn't log you in as 'reggie''
     ...
     And  she should not have an auth_token cookie
     And  her session store should not have admin_id
  ...
  #
  Scenario: Anonymous (logged out) admin can log out.
    Given an anonymous admin
  ...
  Scenario: Logged in admin can log out.
    Given an activated admin logged in as 'reggie'
    When  she goes to /logout
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see a notice message 'You have been logged out'
