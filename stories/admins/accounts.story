...
Story: Creating an account
  ...
  #
  Scenario: Anonymous admin can start creating an account
    Given an anonymous admin
    When  she goes to /signup
    Then  she should be at the 'admins/new' page
  ...
  # Account Creation
  #
  Scenario: Anonymous admin can create an account
    Given an anonymous admin
     And  no admin with login: 'Oona' exists
    ...
    Then  she should see a notice message 'Thanks for signing up!'
     And  a admin with login: 'oona' should exist
     And  the admin should have login: 'oona', and email: 'unactivated@example.com'
  ...
  Scenario: Anonymous admin can not create an account replacing an activated account
    Given an anonymous admin
     And  an activated admin named 'Reggie'
     And  we try hard to remember the admin's updated_at, and created_at
    ...
    Then  she should be at the 'admins/new' page
     ...
     And  a admin with login: 'reggie' should exist
     And  the admin should have email: 'registered@example.com'

     And  the admin's created_at should stay the same under to_s
     And  the admin's updated_at should stay the same under to_s
     And  she should not be logged in

  #
  # Account Creation Failure: Incomplete input
  #
  Scenario: Anonymous admin can not create an account with incomplete or incorrect input
    Given an anonymous admin
     And  no admin with login: 'Oona' exists
    ...
    Then  she should be at the 'admins/new' page
     ...
     And  no admin with login: 'oona' should exist
     
  Scenario: Anonymous admin can not create an account with no password
    Given an anonymous admin
     And  no admin with login: 'Oona' exists
  ...
  Scenario: Anonymous admin can not create an account with no password_confirmation
    Given an anonymous admin
     And  no admin with login: 'Oona' exists
  ...
  Scenario: Anonymous admin can not create an account with mismatched password & password_confirmation
    Given an anonymous admin
     And  no admin with login: 'Oona' exists
  ...
  Scenario: Anonymous admin can not create an account with bad email
    Given an anonymous admin
     And  no admin with login: 'Oona' exists
